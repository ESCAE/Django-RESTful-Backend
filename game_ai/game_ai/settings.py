"""
Django settings for game_ai project.
...
SECRET_KEY = '*g&qee4c0b$sh3ckij!i(g%!5@jz^do6a611+893l1p9$sb8a3'
...
WSGI_APPLICATION = 'game_ai.wsgi.application'
